...
class RenderFunc:
    ...
    def render_all(self, images, results, cameras, extra_mesh):
        ...
        render_results = self.render.render_image(results, images, cameras, extra_mesh=extra_mesh)
        render_results = {
            cam: [res[nv] for res in render_results]
...
def get_ext(mode):
    ext = {
        'image': '.jpg', 'color': '.jpg', 'blend': '.jpg', 'depth': '.png', 'mask': '.png',
        'instance': '.png', 'instance-mask': '.png', 'instance-depth': '.png',
        'instance-depth-twoside': '.png', 'side': '.jpg'
    }.get(mode, '.jpg')
    return ext
