'''
  ...
  @ FilePath: /EasyMocap/apps/demo/mv1p_ioi.py
'''
import os
...
from easymocap.mytools import Timer, projectN3, simple_recon_person
...
if __name__ == "__main__":
    from easymocap.dataset import CONFIG, MV1PMF_IOI
    from easymocap.mytools import load_parser, parse_parser_ioi
    parser = load_parser()
    parser.add_argument('--skel', action='store_true')
    args = parse_parser_ioi(parser)
