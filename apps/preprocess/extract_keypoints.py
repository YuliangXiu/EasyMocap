...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default='openpose',
        choices=[
            'openpose', 'feet', 'feetcrop', 'openposecrop', 'yolo-hrnet', 'yolo', 'hrnet',
            'mp-pose', 'mp-holistic', 'mp-handl', 'mp-handr', 'mp-face'
        ],
        help="model to extract joints from image"
    )
    # Openpose
    parser.add_argument('--openpose', type=str, default=os.environ.get('openpose', 'openpose'))
    ...
    parser.add_argument('--wild', action='store_true', help='remove crowd class of yolo')
