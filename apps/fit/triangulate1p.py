...
'''
    ...
    parser.add_argument('--det2d', type=str, default='localhost:-1', help='detector server address')
    parser.add_argument('--vis3d', type=str, default='localhost:-1', help='vis3d server address')
    ...
    if flag_3d:
        try:
            ...
            cmd = 'python3 apps/vis/vis_server.py --cfg config/vis3d/o3d_scene_manol.yml host {} port {}'.format(
                ip_3d, port_3d
            )
            run_cmd(cmd, bg=True)
            time.sleep(10)
